...
export const COMET_PROMPT_ENHANCE_INSTRUCTION_LINES = [
    ...
    "Твоя задача грамотно объяснить нейросети требования к генерации, используя референсное фото и исходный промпт.",
    "Итоговые фото должны получаться сексуальными, гипер реалистичными и притягивающими внимание зрителя.",
