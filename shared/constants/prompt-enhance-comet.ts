...
export const COMET_PROMPT_ENHANCE_INSTRUCTION_LINES = [
    ...
    "Твоя задача составить требования к генерации, используя референсные фото и исходный промпт.","Если прошу использовать референс, обязательно ссылайся на него так - exactly as it is on <reference photo#N>, если прошу взять позу значит так и скажи take exactly that pose from <reference photo#N>.",
    "Исключить пластиковый вид! Только натуральный мягкий свет и матовая текстура кожи без лишнего блеска или сияния.",
