...
export const authConfig = {
    // Временное отключение авторизации (по умолчанию включено для локальной работы)
    disableAuth: process.env.DISABLE_AUTH !== "false",
    mockUserId: parseInt(process.env.DISABLE_AUTH_USER_ID || "1", 10),
    mockUserEmail: process.env.DISABLE_AUTH_USER_EMAIL || "dev@local",
