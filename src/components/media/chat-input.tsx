...
export const ChatInput = forwardRef<ChatInputRef, ChatInputProps>(
    function ChatInput(
        ...
        return (
            <div
                id='chat-input'
                className='absolute bottom-6 left-1/2 -translate-x-1/2 w-[96%] max-w-4xl bg-slate-950/60 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl shadow-cyan-900/20 p-4 z-20 transition-all duration-300'
            >
                {/* Прикрепленные файлы */}
