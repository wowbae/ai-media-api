...
export const ChatInput = forwardRef<ChatInputRef, ChatInputProps>(
  function ChatInput(
    ...
    const [format, setFormat] = useState<"1:1" | "9:16" | "16:9" | undefined>(
      undefined,
    );
    const [quality, setQuality] = useState<"1k" | "2k" | "4k" | undefined>(
      undefined,
    );
    const [videoFormat, setVideoFormat] = useState<"16:9" | "9:16" | undefined>(
      undefined,
    );
    ...
    const [outputFormat, setOutputFormat] = useState<"png" | "jpg" | undefined>(
      undefined,
    );
    ...
    const isVeo = currentModel === "VEO_3_1_FAST" || currentModel === "VEO_3_1";
    ...
    useEffect(() => {
      ...
      const videoFormatValue = (settings as { videoFormat?: "16:9" | "9:16" })
        .videoFormat;
      if (videoFormatValue) {
      ...
      try {
        ...
        if (isTestMode) {
          ...
          result = await generateMedia({
            ...
            ...((isNanoBanana || isNanoBananaPro || isNanoBananaProKieai) &&
              format && { format }),
            ...((isNanoBanana || isNanoBananaPro || isNanoBananaProKieai) &&
              quality && { quality }),
            ...(isNanoBananaProKieai && outputFormat && { outputFormat }),
            ...(isVeo && videoFormat && { ar: videoFormat }),
            ...(isKling &&
              klingAspectRatio && {
                format: klingAspectRatio,
              }),
            ...(isKling && klingDuration && { duration: klingDuration }),
            ...(isKling && klingSound !== undefined && { sound: klingSound }),
          }).unwrap();
          console.log(
      ...
      <div className="border-t border-slate-700 bg-slate-800/50 p-4">
            ...
            <Select
              ...
              onValueChange={(value) => {
                const newVideoFormat =
                  value === "default" ? undefined : (value as "16:9" | "9:16");
          ...
          {isNanoBananaProKieai && (
            <>
              <Select
                value={format || "1:1"}
                onValueChange={(value) => {
                  const newFormat = value as "1:1" | "9:16" | "16:9";
                  setFormat(newFormat);
                  saveMediaSettings({
                    format: newFormat,
                    quality,
              ...
              <Select
                value={quality || "4k"}
                onValueChange={(value) => {
                  const newQuality = value as "1k" | "2k" | "4k";
                  setQuality(newQuality);
                  saveMediaSettings({
                    format,
                    quality: newQuality,
          ...
          {isKling && (
            <>
              <Select
                ...
                onValueChange={(value) => {
                  const newAspectRatio = value as "16:9" | "9:16";
              ...
              <Select
                ...
                onValueChange={(value) => {
                  const newDuration = parseInt(value) as 5 | 10;
              ...
              <Select
                value={
                  klingSound === undefined ? "true" : klingSound.toString()
                }
                onValueChange={(value) => {
              ...
              >
                <SelectTrigger className="w-[100px] border-slate-600 bg-slate-700 text-white">
                  <SelectValue placeholder="Звук">
                    {klingSound === undefined || klingSound ? "Да" : "Нет"}
                  </SelectValue>
                </SelectTrigger>
                <SelectContent className="border-slate-700 bg-slate-800">
                  <SelectItem
        ...
        <div className="relative">
          ...
          <Button
            ...
            disabled={
              isDisabled || (!prompt.trim() && attachedFiles.length === 0)
            }
          >
