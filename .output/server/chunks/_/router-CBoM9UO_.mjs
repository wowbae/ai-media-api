...
const appCss = "/assets/styles-7mZzIX6X.css";
...
const $$splitComponentImporter$1 = () => import('./index-BbW6Uuya.mjs');
const Route$1 = createFileRoute("/media/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./_chatId-DcPX6vRp.mjs');
...
//# sourceMappingURL=router-CBoM9UO_.mjs.map
