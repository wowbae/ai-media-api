...
import { Loader2, UserPlus, LogIn, LinkIcon, FlaskConical, Plus, MessageSquare, X, Paperclip, Lock, Unlock, Send, ChevronDown, Pin, ImageIcon, VideoIcon, RefreshCcw, Download, Zap, RefreshCw, MoreVertical, Pencil, Trash2, XIcon, Copy, AlertCircle, Maximize2, ChevronDownIcon, CheckIcon, ChevronUp, Sparkles, Video, Music, CheckCircle2, ChevronUpIcon, FileIcon, AudioLines } from 'lucide-react';
...
const appCss = "/assets/styles-CT9wFgPZ.css";
...
const $$splitComponentImporter$4 = () => import('./index-DtKfhDc_.mjs');
const Route$4 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./index-BlprT07b.mjs');
const Route$3 = createFileRoute("/media/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./index-C53ma_Y6.mjs');
  ...
  async function handleDeleteChat(chatId) {
    ...
    try {
      ...
      if (chatId === currentChatId) {
        navigate({ to: routeBase === "/ai-model" ? "/ai-model" : "/media" });
      }
    } catch (error) {
...
function ChatItem({ chat, isActive, onDelete, onEdit, routeBase }) {
  return /* @__PURE__ */ jsxDEV(
    "div",
    {
      className: cn(
...
function ProviderBadge({ provider, className }) {
  ...
  return /* @__PURE__ */ jsxDEV(
    ...
    {
      variant: "outline",
      className: `ml-auto text-[10px] px-1.5 py-0 h-4 font-normal ${config2.className} ${className || ""}`,
...
function useChatInputFiles(chatId, appMode = APP_MODES.DEFAULT) {
      ...
      try {
        ...
        if (isTestMode) {
          ...
          result = await generateMedia({
            ...
            ...currentModel === "Z_IMAGE_TURBO_LORA_WAVESPEED" && params.loras && params.loras.length > 0 && {
              loras: params.loras
            }
          }).unwrap();
          console.log(
...
const ChatInput = forwardRef(
  function ChatInput2({
    ...
    const loraFileInputRef = useRef(null);
    ...
    useImperativeHandle(ref, () => ({
      ...
      setRequestData: async (request) => {
        ...
        if (Array.isArray(settings2.loras)) {
          const nextLoras = settings2.loras.filter(
            (lora) => typeof lora.path === "string" && lora.path.trim().length > 0
          ).slice(0, 3).map((lora) => ({
            path: String(lora.path).trim(),
            scale: typeof lora.scale === "number" ? lora.scale : void 0
          }));
          setLoras(nextLoras);
        } else {
          setLoras([]);
    ...
    const onSubmit = useCallback(
      (event) => {
        ...
        const params = {
          ...
          klingMotionCharacterOrientation: settings.klingMotionCharacterOrientation,
          klingMotionVideoQuality: settings.klingMotionVideoQuality,
          loras: loras.filter((lora) => lora.path.trim().length > 0).slice(0, 3).map((lora) => ({
            path: lora.path.trim(),
            ...lora.scale !== void 0 ? { scale: lora.scale } : {}
          })),
          appMode
        };
        handleSubmit(event, {
    ...
    const isZImageTurboLoraModel = currentModel === "Z_IMAGE_TURBO_LORA_WAVESPEED";
    ...
    const addLoraField = useCallback(() => {
      setLoras((prev) => {
    ...
    const updateLoraField = useCallback(
      (index, updates) => {
        setLoras(
          (prev) => prev.map(
            (item, idx) => idx === index ? { ...item, ...updates } : item
          )
        );
      },
      []
    );
    const removeLoraField = useCallback((index) => {
    ...
    const handleLoraFileSelect = useCallback(
      async (event) => {
        ...
        try {
          ...
          const fileBase64 = await new Promise(
            (resolve, reject) => {
              const reader = new FileReader();
          ...
          const errorMessage = error && typeof error === "object" && "data" in error && error.data && typeof error.data === "object" && "error" in error.data && typeof error.data.error === "string" ? error.data.error : "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C LoRA \u0444\u0430\u0439\u043B";
          alert(errorMessage);
        } finally {
    ...
    return /* @__PURE__ */ jsxDEV(
      "div",
      {
        ...
        children: [
          ...
          isZImageTurboLoraModel && /* @__PURE__ */ jsxDEV("div", { className: "mb-2 space-y-2", children: [
            /* @__PURE__ */ jsxDEV(
              "input",
              {
            ...
            /* @__PURE__ */ jsxDEV("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxDEV("p", { className: "text-xs text-muted-foreground", children: "LoRA (\u0434\u043E 3): \u0443\u043A\u0430\u0436\u0438\u0442\u0435 `path` \u0438 optional `scale`" }, void 0, false, {
                fileName: "/Users/wowbae/Desktop/IT/JS/\u041F\u0440\u043E\u0435\u043A\u0442\u044B/ai-media-api/src/components/media/chat-input.tsx",
                lineNumber: 798,
                columnNumber: 29
              }, this),
              /* @__PURE__ */ jsxDEV("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxDEV(
                  Select,
                  {
                    ...
                    disabled: isDisabled || serverLoraFiles.length === 0,
                    children: [
                      /* @__PURE__ */ jsxDEV(SelectTrigger, { className: "w-[260px] border-border bg-secondary text-foreground rounded-xl h-7 text-xs", children: /* @__PURE__ */ jsxDEV(SelectValue, { placeholder: "\u0412\u044B\u0431\u0440\u0430\u0442\u044C LoRA \u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u0430" }, void 0, false, {
                        fileName: "/Users/wowbae/Desktop/IT/JS/\u041F\u0440\u043E\u0435\u043A\u0442\u044B/ai-media-api/src/components/media/chat-input.tsx",
                        lineNumber: 811,
                        columnNumber: 41
                      }, this) }, void 0, false, {
                      ...
                      /* @__PURE__ */ jsxDEV(SelectContent, { children: serverLoraFiles.map((item) => /* @__PURE__ */ jsxDEV(
                        SelectItem,
                        {
                          value: item.url,
                          className: "text-xs",
                ...
                /* @__PURE__ */ jsxDEV(
                  Button,
                  {
                    ...
                    disabled: isDisabled || loras.length >= 3 || !selectedServerLoraUrl,
                    className: "h-7 text-xs",
                    children: "Add from server"
                  },
                  void 0,
                  false,
                  {
                ...
                /* @__PURE__ */ jsxDEV(
                  Button,
                  {
                    ...
                    className: "h-7 text-xs",
                    children: [
                      /* @__PURE__ */ jsxDEV(Paperclip, { className: "h-3 w-3 mr-1" }, void 0, false, {
                        fileName: "/Users/wowbae/Desktop/IT/JS/\u041F\u0440\u043E\u0435\u043A\u0442\u044B/ai-media-api/src/components/media/chat-input.tsx",
                        lineNumber: 849,
                        columnNumber: 37
                      }, this),
                ...
                /* @__PURE__ */ jsxDEV(
                  Button,
                  {
                    ...
                    className: "h-7 text-xs",
                    children: [
                      /* @__PURE__ */ jsxDEV(Plus, { className: "h-3 w-3 mr-1" }, void 0, false, {
                        fileName: "/Users/wowbae/Desktop/IT/JS/\u041F\u0440\u043E\u0435\u043A\u0442\u044B/ai-media-api/src/components/media/chat-input.tsx",
                        lineNumber: 860,
                        columnNumber: 37
                      }, this),
            ...
            loras.map((lora, index) => /* @__PURE__ */ jsxDEV("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxDEV(
                Input,
                {
                  type: "text",
                  ...
                  value: lora.path,
                  onChange: (e) => updateLoraField(index, {
                    path: e.target.value
                  }),
                  disabled: isDisabled,
              ...
              /* @__PURE__ */ jsxDEV(
                NumberInput,
                {
                  placeholder: "scale",
                  value: lora.scale,
                  onValueChange: (value) => updateLoraField(index, { scale: value }),
                  disabled: isDisabled,
          ...
          isAiModelMode && /* @__PURE__ */ jsxDEV("div", { className: "flex gap-2 mb-2", children: [
            /* @__PURE__ */ jsxDEV(
              Input,
              {
                type: "text",
...
const $$splitComponentImporter$1 = () => import('./_chatId-BOBvvUQX.mjs');
  ...
  if (isChatLoading && !chat) {
    return /* @__PURE__ */ jsxDEV("div", { className: "flex h-screen bg-background", children: [
      /* @__PURE__ */ jsxDEV(ChatSidebar, { appMode, routeBase }, void 0, false, {
        fileName: "/Users/wowbae/Desktop/IT/JS/\u041F\u0440\u043E\u0435\u043A\u0442\u044B/ai-media-api/src/routes/media/$chatId.tsx",
        lineNumber: 228,
        columnNumber: 17
      }, this),
...
const $$splitComponentImporter = () => import('./_chatId-DSFXUkam.mjs');
...
export { APP_MODES as A, ChatSidebar as C, MessageList as M, PANEL_HEADER_CLASSES as P, useCreateChatMutation as a, useGetChatQuery as b, useUpdateChatMutation as c, useGenerateMediaMutation as d, useLazyGetRequestQuery as e, useTestMode as f, useGetModelsQuery as g, API_BASE_URL as h, ChatInput as i, MediaGallery as j, cn as k, getModelIcon as l, MediaChatPage as m, router as r, useGetChatsQuery as u };
//# sourceMappingURL=router-B09gZx3S.mjs.map
