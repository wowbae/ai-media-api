...
import { u as useGetChatsQuery, a as useCreateChatMutation, k as useDeleteChatMutation, h as useUpdateChatMutation, i as useGenerateMediaMutation, o as useGenerateMediaTestMutation, d as useGetModelsQuery, l as useUploadToImgbbMutation, m as useUploadUserMediaMutation, n as handleSessionTimeout } from './router-CBoM9UO_.mjs';
...
function useModelSettings(currentModel) {
  ...
  useEffect(() => {
    ...
    if (modelType.isKlingMotionControl) {
      newSettings.klingMotionCharacterOrientation = storedSettings.klingMotionCharacterOrientation ?? config.characterOrientation?.defaultValue;
      newSettings.klingMotionVideoQuality = storedSettings.klingMotionVideoQuality ?? (config.mode?.defaultValue === "pro" ? "1080p" : "720p");
    }
    if (config.duration) {
...
export { Button as B, ChatSidebar as C, Dialog as D, ModelBadge as M, PANEL_HEADER_CLASSES as P, ScrollArea as S, ChatInput as a, createLoadingEffectForAttachFile as b, cn as c, PANEL_HEADER_TITLE_CLASSES as d, Skeleton as e, DialogContent as f, getModelIcon as g, DialogTitle as h, getOriginalFileUrl as i, downloadFile as j, getProviderDisplayName as k, getMediaFileUrl as l, isVideoDataUrl as m, formatTime as n, formatFileSize as o, Badge as p, toDirectImageUrl as t, useTestMode as u };
//# sourceMappingURL=chat-input-zdWjKpr9.mjs.map
